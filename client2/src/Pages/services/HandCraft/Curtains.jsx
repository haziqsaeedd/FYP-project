...
import { FaStream,FaWindowMaximize} from "react-icons/fa";
...
const serviceOptions = [
  { value: "Curtain Rod Installation/Repair", label: "Curtain Rod Installation/Repair", icon: <FaStream /> },
  { value: "Curtain Cleaning", label: "Curtain Cleaning", icon: <GiTheaterCurtains /> },
...
useEffect(() => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Curtins or Blind Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert Curtins or blinds installation or cleaning at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
