...
const serviceOptions = [
  { value: "Ceiling/Exhaust Fan Installation", label: "Ceiling/Exhaust Fan Installation", icon: <FaFan /> },
  { value: "Fan Repair", label: "Fan Repair", icon: <FaTools /> },
];
...
useEffect(() => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Ceiling/Exhaust Installation and Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert Ceiling/Exhaust Fan installation, repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
