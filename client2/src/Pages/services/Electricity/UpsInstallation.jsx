...
const serviceOptions = [
  { value: "UPS Installation", label: "UPS Installation", icon: <FaBatteryHalf /> },
  { value: "UPS Repair", label: "UPS Repair", icon: <FaTools /> },
];
...
const UpsInstallation = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">UPS/Inverter Installation and Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert UPS installation, repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
...
export default UpsInstallation;
