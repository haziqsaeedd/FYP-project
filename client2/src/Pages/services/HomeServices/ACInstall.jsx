...
import { FaSnowflake, FaWrench, FaPumpSoap } from "react-icons/fa";

const serviceOptions = [
  { value: "AC Installation", label: "AC Installation", icon: <FaSnowflake /> },
  { value: "AC Repair & Gas Refilling", label: "AC Repair & Gas Refilling", icon: <FaWrench /> },
   { value: "AC Service", label: "AC Service", icon: <FaPumpSoap /> },
];
...
const AcInstallation = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">AC Installation and Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert AC or DC installation, repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
