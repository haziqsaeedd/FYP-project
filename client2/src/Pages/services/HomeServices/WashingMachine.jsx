...
import { FaTools, FaPumpSoap } from "react-icons/fa";
import { useContext, useEffect } from "react";
import { AuthContext } from "../../../context/AuthContext"; 
import { useNavigate, useLocation } from "react-router-dom";

const serviceOptions = [
  { value: "washing Machine Installation", label: "Washing Machine Installation", icon: <FaPumpSoap /> },
  { value: "Washing Machine Repair", label: "Washing Machine Repair", icon: <FaTools /> },
...
useEffect(() => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Washing Machine Installation and Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert Washing Machine installation, repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
