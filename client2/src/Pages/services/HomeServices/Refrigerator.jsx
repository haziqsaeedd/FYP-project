...
useEffect(() => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Refrigerator Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert Refrigerator repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow">
        ...
        <div>
          <label className="block mb-2 font-medium">Choose Your Refrigerator</label>
