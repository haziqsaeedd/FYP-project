...
import { FaTools, FaFireAlt,FaUtensils } from "react-icons/fa";
...
const serviceOptions = [
  { value: "Stove Oven Installation", label: "Stove OvenInstallation", icon: <FaUtensils/> },
  { value: "Stove Oven Repair", label: "Stove Oven Repair", icon: <FaTools /> },
  { value: "Micro Oven Repair", label: "Micro Oven Repair", icon: <FaFireAlt /> },
...
useEffect(() => {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    address: '',
    category: 'Home Applience', // matches backend
    service: '',
    message: '',
  });
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Oven Installation and Repair Services</h1>
      <p className="text-gray-600 mb-6">
        HOMO provides expert Microwave or StoveOven installation, repair, and maintenance at your doorstep. With 6+ years of experience and 50,000+ satisfied customers, you can rely on our trusted professionals.
      </p>
