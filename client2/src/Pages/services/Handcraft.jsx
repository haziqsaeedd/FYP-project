...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ firstName: '', lastName: '', email: '', phone: '', address: '', service: 'Handcraft', message: '' });
    } catch (error) {
  ...
  return (
    <div className="p-6">
      {/* Top Heading Section */}
      <h1 className="text-3xl font-bold text-blue-800 mb-2">HandCraft Services</h1>
      <p className="text-gray-600 mb-6">We offer reliable handcraft services for both residential and commercial clients. Book now or explore our services below.</p>

      {/* Booking Form */}
      <div className="bg-white rounded-xl shadow p-6 max-w-3xl mx-auto mb-12">
        <h2 className="text-xl font-semibold text-blue-700 mb-4">📋 Book a Handcraft</h2>
